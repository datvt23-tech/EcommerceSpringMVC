...
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
        <div class="sidebar-header">
            <a class="brand-mark" href="${pageContext.request.contextPath}/staff/dashboard" aria-label="adminHMD dashboard">
        ...
        <nav class="sidebar-nav">
            <a class="nav-link active" href="${pageContext.request.contextPath}/staff/dashboard" aria-current="page">
...
<!--                <a class="nav-link" href="${pageContext.request.contextPath}/admin/users">
            ...
            <a class="nav-link" href="${pageContext.request.contextPath}/product/staff/list">
            ...
            <a class="nav-link" href="${pageContext.request.contextPath}/staff/support">
